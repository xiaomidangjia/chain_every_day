...
fig_new.text(0.5, 0.95, '0xCarson出品，lian xi+V：shengxiaruchu009', transform=ax.transAxes,
        fontsize=150, color='gray', alpha=0.5,
        ha='center', va='center', rotation='30',fontproperties = prop)

fig_new.text(0.5, 0.85, '0xCarson出品，lian xi+V：shengxiaruchu009', transform=ax.transAxes,
        fontsize=150, color='gray', alpha=0.5,
        ha='center', va='center', rotation='30',fontproperties = prop)

fig_new.text(0.5, 0.75, '0xCarson出品，lian xi+V：shengxiaruchu009', transform=ax.transAxes,
        fontsize=150, color='gray', alpha=0.5,
        ha='center', va='center', rotation='30',fontproperties = prop)
